...
from diffusers import AutoencoderKL, DDIMScheduler, DDPMScheduler, StableDiffusionPipeline, UNet2DConditionModel, EulerAncestralDiscreteScheduler
...
def main(args):
    ...
    def save_weights(step):
        ...
        if accelerator.is_main_process:
            ...
            scheduler = EulerAncestralDiscreteScheduler.from_pretrained(args.pretrained_model_name_or_path, subfolder="scheduler", prediction_type="v_prediction")
            pipeline = StableDiffusionPipeline.from_pretrained(
                args.pretrained_model_name_or_path,
